...
import {  useDispatch, useSelector} from 'react-redux'  // istimcaal hada Value wacrysi
import { incriment,decriment,reset } from '../redux/reducer/counter'

function App() {
   const value = useSelector((state) => state.tasbiix.tasbiihValue)

   const Dispatch = useDispatch() //waxo access gareya redux function

   const handleIncrement= () => {
    Dispatch((incriment(10)))
   }
